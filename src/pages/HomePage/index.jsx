...
export default function HomePage() {
	return (
		<div>
			<div className="px-5 py-6 bg-custom-black">
						...
						<div className="flex flex-row mt-4 pl-4">
							<div className="flex flex-col">
								<div className="rounded-lg hover:bg-card-sideNav">
									<div className="hover:text-white p-3">Crane 1</div>
								</div>
								<div className="rounded-lg hover:bg-card-sideNav">
									<div className="hover:text-white p-3">Crane 2</div>
								</div>
								<div className="rounded-lg hover:bg-card-sideNav">
									<div className="hover:text-white p-3">Crane 3</div>
								</div>
								<div className="rounded-lg hover:bg-card-sideNav">
									<div className="hover:text-white p-3">Crane 4</div>
								</div>
							</div>
